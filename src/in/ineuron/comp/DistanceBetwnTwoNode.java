...
public static void main(String[] args)
{
	...
	System.out.println("Dist(8, 3) = " +
					findDistance(root, 8, 3));
	System.out.println("Dist(8, 10) = " +
					findDistance(root, 8, 10));
	System.out.println("Dist(1, 6) = " +
					findDistance(root, 1, 6));
	System.out.println("Dist(7, 4) = " +
					findDistance(root, 7, 4));
	System.out.println("Dist(10, 1) = " +
					findDistance(root, 10, 1));
}
}
